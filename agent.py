...
def run_task_v3(task):
    """
    Execute one TaskV3 through the production V3 runtime.

    The legacy run_task() path remains unchanged.
    """
    ...
    return V3Runtime.create_default().execute(
        task,
